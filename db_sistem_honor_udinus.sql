...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 23 Des 2025 pada 03.20
...
INSERT INTO `t_panitia` (`id_panitia`, `jabatan_panitia`, `honor_standar`, `honor_p1`, `honor_p2`) VALUES
(1, 'ketua panitia', 50000, NULL, NULL),
(2, 'wakil ketua', 45000, NULL, NULL),
(3, 'sekretaris', 40000, NULL, NULL),
(4, 'bendahara', 40000, NULL, NULL);
...
CREATE TABLE `t_transaksi_honor_dosen` (
  `id_transaksi_honor_dosen` int(11) NOT NULL,
  `semester` varchar(5) NOT NULL,
  `bulan` enum('januari','februari','maret','april','mei','juni','juli','agustus','september','oktober','november','desember') NOT NULL,
  `kode_dosen` int(11) NOT NULL,
  `hari_jam` datetime NOT NULL,
  `sks` int(11) NOT NULL,
  `honor_persks` int(11) NOT NULL,
  `pagu_honor` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `t_transaksi_ujian` (
  `id_transaksi_ujian` int(11) NOT NULL,
  `semester` varchar(10) NOT NULL,
  `id_panitia` int(11) NOT NULL,
  `id_user` int(11) NOT NULL,
  `jumlah_mahasiwa_prodi` int(11) NOT NULL,
  `jumlah_mahasiwa` int(11) NOT NULL,
...
CREATE TABLE `t_user` (
  ...
  `no_rekening_user` varchar(30) NOT NULL,
...
INSERT INTO `t_user` (`id_user`, `npp_user`, `nik_user`, `npwp_user`, `no_rekening_user`, `nama_user`, `nohp_user`, `password_user`, `role_user`) VALUES
(1, '0686.11.1995.071', '3374010101950001', '12.345.678.9-012.000', '1410001234567', 'Dr. Andi Prasetyo, M.Kom', '081234567801', 'f006bbb5314696993ac4b77c9eabc7e1', 'admin'),
(2, '0721.12.1998.034', '3374010202980002', '23.456.789.0-123.000', '1410002345678', 'Siti Rahmawati, M.T', '081234567802', '740b977c51fa5bfd17f8f23f809ee6d5', 'koordinator'),
(3, '0815.10.2001.112', '3374010303010003', '34.567.890.1-234.000', ' 1410003456789', ' Budi Santoso, S.Kom ', ' 081234567803', 'd9dcc4af188a7a70fbd1d0294223cb06', 'staff');
...
ALTER TABLE `t_transaksi_honor_dosen`
  ADD PRIMARY KEY (`id_transaksi_honor_dosen`);

--
-- Indeks untuk tabel `t_transaksi_pa_ta`
--
ALTER TABLE `t_transaksi_pa_ta`
  ADD PRIMARY KEY (`id_transaksi_pa_ta`),
...
ALTER TABLE `t_transaksi_ujian`
  ADD PRIMARY KEY (`id_transaksi_ujian`),
  ADD KEY `id_user` (`id_user`),
  ADD KEY `id_panitia` (`id_panitia`);
...
--
ALTER TABLE `t_transaksi_honor_dosen`
  MODIFY `id_transaksi_honor_dosen` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `t_transaksi_pa_ta`
--
ALTER TABLE `t_transaksi_pa_ta`
  MODIFY `id_transaksi_pa_ta` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `t_transaksi_ujian`
--
ALTER TABLE `t_transaksi_ujian`
  MODIFY `id_transaksi_ujian` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `t_transaksi_pa_ta`
  ADD CONSTRAINT `t_transaksi_pa_ta_ibfk_1` FOREIGN KEY (`id_panitia`) REFERENCES `t_panitia` (`id_panitia`),
...
ALTER TABLE `t_transaksi_ujian`
  ...
  ADD CONSTRAINT `t_transaksi_ujian_ibfk_4` FOREIGN KEY (`id_panitia`) REFERENCES `t_panitia` (`id_panitia`);
COMMIT;
